...
cfg = Config()  # automatically reads DATABRICKS_HOST/CLIENT_ID/CLIENT_SECRET, already injected
...
user_question = st.text_input(
    "Your question", placeholder="e.g. What are the top 5 products by revenue?")
